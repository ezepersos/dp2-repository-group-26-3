...
<acme:list>
	<acme:list-column code="manager.task.form.label.title" path="title"/>
	<acme:list-column code="manager.task.form.label.executionPeriodInit" path="executionPeriodInit"/>
